...
THIS GRADUATE TRACER SURVEY INTENDS TO TRACE THE EMPLOYMENT EXPERIENCE(S) OF DAVAO DEL NORTE STATE COLLEGE GRADUATES.</center></h3>
<br><br><br><br>
...
<fieldset><legend><h1 style="font-family: Century Gothic; font-size: 50px;">Log in</h1></legend>
  <form class="modal-content animate" action="" method="POST">
    ...
    <div class="container">
      ...
      <input type="text" name="unameGrad" required>

      <label style="font-family: Century Gothic;"><b>Password</b></label>
      <input type="password" name="pswGrad" required>
