...
<script type="text/javascript">
  $(document).ready(function() {
    $('#otherHS').attr('disabled','disabled');
    $('#ethnicInput').attr('disabled','disabled');
    $('#religionTwo').attr('disabled','disabled');
    $('#otherLight').attr('disabled','disabled');
    $('#otherTransport').attr('disabled','disabled');

    $('select[name="ethnicSlct"]').on('change',function(){
    var  others = $(this).val();
        if(others == "Others"){
        $('#ethnicInput').removeAttr('disabled');
        ethnicInput.focus();
         }else{
         $('#ethnicInput').attr('disabled','disabled');
        }
    ...
    $('select[name="hsGraduated"]').on('change',function(){
    var  others = $(this).val();
        if(others == "Others"){
        $('#otherHS').removeAttr('disabled');
        otherHS.focus();
         }else{
         $('#otherHS').attr('disabled','disabled');
        }
    ...
    var  others = $(this).val();
        if(others == "Others"){
        $('#religionTwo').removeAttr('disabled');
        religionTwo.focus();
         }else{
         $('#religionTwo').attr('disabled','disabled');
        }
    ...
    $('select[name="light"]').on('change',function(){
    var  others = $(this).val();
        if(others == "Others"){
        $('#otherLight').removeAttr('disabled');
        otherLight.focus();
         }else{
         $('#otherLight').attr('disabled','disabled');
        }
    ...
    var  others = $(this).val();
        if(others == "Others"){
        $('#otherTransport').removeAttr('disabled');
...
span.onclick = function() {
    modal.style.display = "none";
                   ...
                   <h5>STATUS<b style = "color: red;">*</b></h5>
                    <select id = "type" class="type" name = "type" style="color: black; background-color: white; font-family: latoregular; width:100%;">
                        <option>NEW STUDENT</option>
                        <option>TRANSFEREE STUDENT</option>
                    </select>

                    <h5>SCHOOL YEAR &amp; SEMESTER <b style = "color: red;">*</b></h5>
                            <select class="schoolYear" id="schoolYear" name="schoolYear" style="color: black; background-color: white; font-family: latoregular;">
    ...
    for ($i = 2013; $i <= $current_year; $i++) {?>
                    ...
                    <select id = "semester" name = "semester" class = "semester" style="color: black; background-color: white; font-family: latoregular;">
...
$connection = mysqli_connect("localhost", "root", "");
    ...
    while ($row = mysqli_fetch_array($result)) {
        ?>
              ...
              <input type="text" style="color: black; background-color: white; font-family: latoregular; width: 28%;" name="lname" id="lname" pattern = [a-zA-Z]+ placeholder = "Last Name"  value="<?php echo $row['lname']; ?>" autocomplete="off" />
              <input type="text" style="color: black; background-color: white; font-family: latoregular; width: 28%;" name="fname" id="fname" placeholder = "First Name"  value="<?php echo $row['fname']; ?>" autocomplete="off"/>
              <input type="text" style="color: black; background-color: white; font-family: latoregular; width: 28%;" name="mname" id="mname" placeholder = "Middle Name"  value="<?php echo $row['mname']; ?>" autocomplete="off" />
          <?php
}
    ?>
...
mysqli_connect('localhost', 'root', '');
    ...
    echo "<input type = 'text' name='s1' id='s1' style='color: black; background-color: white; font-family: latoregular; width: 28%;' placeholder = 'Province'>";
    ?>
...
mysqli_connect('localhost', 'root', '');
    ...
    echo "<input type = 'text' name='s2' id='s2' class='city' style='color: black; background-color: white; font-family: latoregular; width: 28%;' placeholder = 'City'>";
...
mysqli_connect('localhost', 'root', '');
    ...
    echo "<input type = 'text' name='s3' id='s3' style='color: black; background-color: white; font-family: latoregular; width: 28%;' class='brgy' placeholder = 'Brgy'>";
    ?>
                            <input type="text" style="color: black; background-color: white; font-family: latoregular; width: 100%;" name="shouseNumber" placeholder = "Lot No. / Blk. No / Street / Subdivision / Purok" id = "shouseNumber">
...
mysqli_connect('localhost', 'root', '');
    ...
    echo "<input type = 'text' name='ss1' id='ss1' class='city' style='color: black; background-color: white; font-family: latoregular; width: 28%;' placeholder = 'Province'>";
    ?>
...
mysqli_connect('localhost', 'root', '');
    ...
    echo "<input type = 'text' name='ss2' id='ss2' class='city' style='color: black; background-color: white; font-family: latoregular; width: 28%;'  placeholder = 'City'>";
    ?>
...
mysqli_connect('localhost', 'root', '');
    ...
    echo "<input type = 'text' name='ss3' id='ss3' style='color: black; background-color: white; font-family: latoregular; width: 28%;' class='brgy'  placeholder = 'Brgy'>";
    ?>
                            <input type="text" name="sshouseNumber" style="color: black; background-color: white; font-family: latoregular; width: 100%;" placeholder = "Lot No. / Blk. No / Street / Subdivision / Purok" id = "sshouseNumber">
              ...
              <select id="course" name="course" style="color: black; background-color: white; font-family: latoregular;">
              ...
              <h5>BIRTHDAY</h5>
              <input type="text" name="nominee_one_dob" style="color: black; background-color: white; font-family: latoregular;" id="nominee_one_dob">
              <input type="text" placeholder = "Your age" name = "age" id="age" style="color: black; background-color: white; font-family: latoregular;">

              <h5>GENDER <b style = "color: red;">*</b></h5>
              <select id="gender" name="gender" style="color: black; background-color: white; font-family: latoregular;">
              <option>–– Choose below ––</option>
              ...
              <select id="status" name="status" style="color: black; background-color: white; font-family: latoregular;" onchange="Status(this)">
                <option>–– Choose below ––</option>
              ...
              <input type="text" name = "spouse" id = "spouse" disabled="disabled" style="color: black; background-color: white; font-family: latoregular; width: 100%;" placeholder = "If married, name of spouse">
              <h5>NATIONALITY <b style = "color: red;">*</b></h5>
              <input type="text" style="color: black; background-color: white; font-family: latoregular;" name = "nationality" id = "nationality" placeholder = "State your nationality" />
              ...
              <select style="font-family: Century Gothic;" name="nSibling" id="nSibling">
                ...
                <option>4</option>
                            ...
                            <button type="button" style="width:49%; font-family: latoregular;" value='Add' id='addButton3' class="cancelbtn3">Add Sibling</button>
                            <button type="button" style="width:49%; font-family: latoregular;" value='Add' id='removeButton3' class="cancelbtn3">Remove Sibling</button>
                            </div>
                            <br>
                           <h5>NUMBER OF SIBLINGS CURRENTLY ENROLLED AT DNSC <b style = "color: red;">*</b></h5>
                            <select style="color: black; background-color: white; font-family: latoregular; width: 100%;" name="sibling2" class="sibling2" id="sibling2">
                                <option>0</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                            ...
                            <select id = "hsGraduated" name = "hsGraduated" required="true" style="color: black; background-color: white; font-family: latoregular; width: 65%;">
                            <option>–– Choose below ––</option>
                             <?php
mysqli_connect('localhost', 'root', '');
    mysqli_select_db('tryit');
    ...
    ?>
              <option value="Others">NOT IN THE LIST</option>
                    ...
                    <select id="yearGrad" name="yearGrad" style="color: black; background-color: white; font-family: latoregular;">
    ...
    for ($i = 1990; $i <= $current_year; $i++) {?>
            ...
            <?php
                    ...
                    <input id = "otherHS" class="otherHS" style="color: black; background-color: white; font-family: latoregular; width: 100%;" name="otherHS" disabled = "true" type="text" placeholder = "If not in the list, please specify.">

                            <h5>TYPE OF HIGH SCHOOL ORIGIN <b style = "color: red;">*</b></h5>
                            <select id="hsType" name="hsType" style="color: black; background-color: white; font-family: latoregular;">
                                <option>–– Choose below ––</option>
              ...
              <select id="stanine" name="stanine" style="color: black; background-color: white; font-family: latoregular;">
                <option>–– Choose below ––</option>
                <optgroup label="Low">
                <option>1</option>
                <option>2</option>
...
$connection = mysqli_connect("localhost", "root", "");
    ...
    while ($row = mysqli_fetch_array($result)) {
        ?>
                            ...
                            <input type="email" style = "color: black; background-color: white; font-family: latoregular;" name = "email" id = "email" value="<?php echo $row['email']; ?>" readonly="readonly" />
    ...
    ?>
              ...
              <input type="text" style="color: black; background-color: white; font-family: latoregular;" name="contact" id="contact" placeholder = "Telephone / Cellphone Number" maxlength="13" value="" autocomplete="off">
          ...
          <hr />
            ...
            <div class="form">
                ...
                <h5> ETHNIC ORIGIN </h5>
                <select id="ethnicSlct" style="color: black; background-color: white; font-family: latoregular;" name="ethnicSlct">
                <option>–– Choose below ––</option>
                  <?php
mysqli_connect('localhost', 'root', '');
    mysqli_select_db('tryit');
    ...
    ?>
              ...
              <input id = "ethnicInput" style="color: black; background-color: white; font-family: latoregular;" name="ethnicInput" disabled = "true" type="text" placeholder = "If not in the list, please specify." value="">
              ...
              <input type="text" style="color: black; background-color: white; font-family: latoregular;" class = "capitalize" name="fatherEd" id="fatherEd" placeholder = "Name" value="" autocomplete="off">
              <select id="fAttain" name="fAttain" style="color: black; background-color: white; font-family: latoregular;">
                ...
                <option>Graduate School</option>
                            ...
                            <input type="text" style="width: 100%; color: black; background-color: white; font-family: latoregular;" id="occupationF" name="occupationF" />
              ...
              <input type="text" style="color: black; background-color: white; font-family: latoregular;" class = "capitalize" name="motherEd" id="motherEd" placeholder = "Name" value="" autocomplete="off">
              <select id="mAttain" name="mAttain" style="color: black; background-color: white; font-family: latoregular;">
                  <option>–– Educational Attainment ––</option>
                <option>Elementary Level</option>
                <option>Elementary Graduate</option>
                <option>High School Level</option>
                ...
                <option>Graduate School</option>
                            ...
                            <input type="text" style="width: 100%; font-family: Century Gothic;color: black; background-color: white; font-family: latoregular;" id="occupationM" name="occupationM" />
...
mysqli_connect('localhost', 'root', '');
    ...
    echo "<select name='religion' id='religion' style='color: black; background-color: white; font-family: latoregular;' onchange='Disable2(this)'>";
    ...
    echo "</select>";
    ?>
              <input type="text" autocomplete="off" style="color: black; background-color: white; font-family: latoregular;" name="religionTwo" id="religionTwo" placeholder = "If not in the list, please specify." value="">

              <h5> DIALECT/S SPOKEN </h5>
              <div class="checkbox">
                    <h6 style = "color: white; font-family: latoregular;"><input id = "chckbx1"  type="checkbox" name="chk1[]" value = "Visayan">Visayan<br>
              ...
              <input type="text" style="color: black; background-color: white; font-family: latoregular; width: 50%;" autocomplete="off" name="otherDialect"  disabled = "true" id = "otherDialect" placeholder = "If others, please specify." value="">
              </h6>
                </div>

                            <h5> SPECIAL SKILLS/TALENTS </h5>
                            <div class="checkbox">
                            <h6 style = "color: white; font-family: latoregular;"><input id = "c1"  type="checkbox" name="chk2[]" value = "Singing">Singing<br>
                            ...
                            <input type="text" style="color: black; background-color: white; font-family: latoregular; width: 50%;" autocomplete="off" name="otherSkills"  disabled = "true" id="otherSkills" placeholder = "If others, please specify." value="">
                            </h6>
                            </div>

                            <h5> TYPE OF DISABILITY (<i>If any, please check and specify</i>) </h5>
                            <div class="checkbox">
                            <h6 style = "color: white; font-family: latoregular;"><input id = "ch1"  type="checkbox" name="chk3[]" value = "Psychosocial Disability">Psychosocial Disability<br>
                            ...
                            <input type="text" style="color: black; background-color: white; font-family: latoregular; width: 50%;" autocomplete="off" name="otherDisability"  disabled = "true" id="otherDisability" placeholder = "If others, please specify." value="">
                            </h6>
                            </div>

                            <h5> HANDEDNESS </h5>
                            <div class="checkbox">
                            <h6 style = "color: white; font-family: latoregular;"><input type="checkbox" name="chk4[]" value = "Right" id = "checkbx1">Right
                            ...
                            <div class="checkbox">
                            <h6 style = "color: white; font-family: latoregular;"><input id = "chbx1"  type="checkbox" name="chk5[]" value = "Parents working abroad">Parents working abroad<br>
                            ...
                            <input type="text" style="color: black; background-color: white; font-family: latoregular; width: 50%;" autocomplete="off" name="otherProblems"  disabled = "true" id="otherProblems" placeholder = "If others, please specify." value="">
                            </h6>
                            </div>
          ...
          <hr />
            ...
            <div class="form">
              ...
              <select id="income" name="income" style="color: black; background-color: white; font-family: latoregular;">
                <option>–– Choose below ––</option>
              ...
              <select id="house" name="house" style="color: black; background-color: white; font-family: latoregular;">
                <option>–– Choose below ––</option>
                <option>Owned</option>
              ...
              <select id="lot" name="lot" style="color: black; background-color: white; font-family: latoregular;">
                <option>–– Choose below ––</option>
                <option>Owned</option>
                <option>Rented/Leased</option>
                <option>None</option>
              ...
              <select id="light" name="light" style="color: black; background-color: white; font-family: latoregular;">
                <option>–– Choose below ––</option>
                <option>Electricity</option>
                <option>Petroleum</option>
                <option value="Others">NOT IN THE LIST</option>
              </select>
              <input type="text" autocomplete="off" style="color: black; background-color: white; font-family: latoregular;" name="otherLight" disabled = "true" id="otherLight" placeholder = "If others, please specify." value="">

              <h5> MEANS OF WATER SUPPLY</h5>
              <select id="water" name="water" style="color: black; background-color: white; font-family: latoregular;">
                <option>–– Choose below ––</option>
              ...
              <select id="toilet" name="toilet" style="color: black; background-color: white; font-family: latoregular;">
                <option>–– Choose below ––</option>
              ...
              <select id="transport" name="transport" style="color: black; background-color: white; font-family: latoregular;">
                <option>–– Choose below ––</option>
                <option>Car</option>
                ...
                <input type="text" autocomplete="off" style="color: black; background-color: white; font-family: latoregular;" name="otherTransport" disabled = "true" id="otherTransport" placeholder = "If others, please specify." value="">

              <h5> APPLIANCES OWNED </h5>
              <div class="checkbox">
                    <h6 style = "color: white; font-family: latoregular;"><input type="checkbox" class="cc" name="check[]" value = "Refrigerator" id = "check1" > Refrigerator<br>
                ...
                <input type="text" autocomplete="off" style="color: black; background-color: white; font-family: latoregular;" name="otherAppliances" id="otherAppliances" disabled = "true" placeholder = "If others, please specify." value="">

                <h5> FURNITURE OWNED </h5>
                <h6 style = "color: white; font-family: latoregular;">
                ...
                <input type="text" autocomplete="off" style="color: black; background-color: white; font-family: latoregular; width: 50%;" name="otherFurniture" id="otherFurniture" disabled = "true" placeholder = "If others, please specify." value="">
          ...
          <h1>YOUR PROFILE</h1>
            <div class="form">
              <table>
                ...
                <tr><td style="font-family: latoregular;">Student Type</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">School Year and Semester</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Name</td><td  style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Permanent Address</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Present Address</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Course</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Birthday and Age</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Gender</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Marital Status</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Nationality</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Sibling Name and Educational Attainment</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">No. of siblings enrolled at DNSC</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Name of High School &amp; Year Graduated</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">High School Type Origin</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Stanine (OLSAT Result)</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Email Address</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Contact Number</td><td style="font-family: latoregular;"></td></tr>
                <tr><td><h2 style="font-family: latoregular;">SOCIAL STATUS</h2></td><td id = "dash" style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Ethnic Origin</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Father's Information</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Mother's Information</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Religion</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Dialect/s spoken</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Special skills/talents</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Type of Disability</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Handedness</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;"latoregular>Problems Encountered</td><td style="font-family: latoregular;"></td></tr>
                <tr><td><h2 style="font-family: latoregular;">ECONOMIC STATUS</h2></td><td id = "dash" style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Family Monthly Income</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Status of the house</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Status of residential lot</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Light facilities</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Means of water supply</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Type of toilet used</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Possession of transportation</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Appliances owned</td><td style="font-family: latoregular;"></td></tr>
                <tr><td style="font-family: latoregular;">Furniture owned</td><td style="font-family: latoregular;"></td></tr>
              </table>
