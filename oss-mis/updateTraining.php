    ...
    <div class="panel-body">
      ...
      <form name="basicform" id="basicform">
        <div id="sf1" class="frm">
          <fieldset>
            <legend style="font-family: Century Gothic;"><b>Training Courses attended after Graduation</b></legend>
...
while ($row = mysqli_fetch_array($result)) {
    ?>
            <table><tr>
            <td><label>Training Title: </label><input type="text" id="training" name="mytext1" class="form-control" autocomplete="off" value="<?php echo $row['titleTraining']; ?>"></td>
            <td><label>Duration and Credits: </label><input type="text" id="credits" name="mytext1" class="form-control" autocomplete="off" value="<?php echo $row['credits']; ?>"></td>
            <td><label>Sponsor/College/University: </label><input type="text" id="sponsor" name="mytext1" class="form-control" autocomplete="off" value="<?php echo $row['sponsor']; ?>"></td>
            </tr></table>
            </div></div>
              <button type="button" value='Add' id='addButton' class="cancelbtn">Add Training</button>
              <button type="button" value='Add' id='removeButton' class="cancelbtn">Remove Training</button>
            </div>
<?php
}
?>
