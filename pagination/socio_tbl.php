...
<script type="text/javascript">
   function printDiv(divId) {
       ...
       document.body.innerHTML = "<html><head><title>Report</title></head><body><center><table><tr colspan='2'><td><img src=dnsc.png width=120 height=120 align='right'></td><td><b style='font-family: Times New Roman;'>Republic of the Philippines<br><b style='font-size: 20px;'>DAVAO DEL NORTE STATE COLLEGE</b><br>New Visayas, Panabo City, Davao del Norte, Philippines 8105<br>Website: www.dnsc.edu.ph; Telephone #: 63 84 6284301<br>Email Address: president@dnsc.edu.ph; <u>jab@dnsc.edu.ph</u><br>OFFICE OF THE GUIDANCE COUNCILOR</b><hr></td></table>" + printContents + "</body></html>";
...
<tr>
  ...
  <tr>
    <td>
<!--<input type="checkbox" name=others onclick="enable_sy(this.checked)">--> <b style = "color: black; font-family: Century Gothic; color: white;">School Year</b><br>
<select name = "from" id = "from" style="font-family: Century Gothic;">
...
<select name="to" id="to" style="font-family: Century Gothic;">
...
<select name = "course" id = "course" style="font-family: Century Gothic;">
...
<td>
<!--<input type="checkbox" name=others onclick="enable_gender(this.checked)">--> <b style = "color: black; font-family: Century Gothic; color: white;">Gender</b><br>
<select name = "gender" id = "gender" style="font-family: Century Gothic;">
...
?>
                        <?php
$result   = mysqli_query("SELECT * FROM personal", $connection);
...
?>
                        <?php
$result = mysqli_query("SELECT * FROM {$statement} LIMIT {$startpoint} , {$limit}", $connection);
