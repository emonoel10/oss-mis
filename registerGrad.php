...
<head>
  ...
  <title>DNSC - Graduates Registration</title>
...
<hr>
<br><br><br><fieldset><legend><h1 style="font-family: Mistral; font-size: 50px;">Register</h1></legend>

  <br><h1 style="font-family: Century Gothic; color: black;">Be a member now. Register here!</h1>
   <center><p style="font-family: Century Gothic; color: red;"><?php echo $_GET['error']; ?></p></center>
  <form class="modal-content animate" action="action_pageGrad.php" method="post">
    <div class="container">
      ...
      <button type="submit" onclick="validate()" id = "submit_sign">Sign Up</button>
    </div>
  </form>
</div>
  </form>
