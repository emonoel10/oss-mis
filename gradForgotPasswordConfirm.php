...
$connection          = new mysqli("localhost", "root", "", "tryit");
    ...
    $resetPasswordCheckerQuery = $connection->query("SELECT * FROM gradResetPassword WHERE graduate_id = '$resetPasswordGradId' AND is_reset = '0';");
    ...
    ?>
        ...
        <script src="assets/js/forgotPassword.js" type="text/javascript">
        </script>
    </body>
</html>
