										...
										<?php
										 $args = array(
											...
											foreach ( $taxonomies as $taxonomy ) {													
													?>
													<input type="checkbox" name="pciwgas_options[pciwgas_category][]" value="<?php echo $taxonomy; ?>" class="" <?php checked(in_array($taxonomy, $selected_cat), true ); ?>> <?php echo $taxonomy;?><br />
