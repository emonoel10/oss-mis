...
{
    $copyrightText = __('All Rights Reserved', 'mesmerize', 'mesmerize');

    $copyrightText = sprintf($copyrightText, get_site_url());
    ...
    $copyright = '<p ' . $previewAtts . ' class="copyright">&copy;&nbsp;' . "&nbsp;" . date_i18n(__('Y', 'mesmerize')) . '&nbsp;' . esc_html(get_bloginfo('name')) . 'Pty ltd.&nbsp;' . wp_kses_post($copyrightText) . '</p>';

    $copyright += '<br/>
    <p ' . $previewAtts . ' >
        <span><a href="' . get_site_url() . '/terms">Terms &#38; Conditions</a> | </span>
        <span><a href="' . get_site_url() . '/terms">Privacy Policy</a> | </span>
        <span><a href="' . get_site_url() . '/terms">Contact Us</a></span>
    </p>';
