<?php 
/**
 * The Custom Style for Perfect Agriculture Lite
 *
...
.featured_block p{color:<?php echo $complete['featured_block_color'] ?>;}


.featured_block{background-color:<?php echo $complete['featured_block_box_bg'] ?>;}
.featured-thumb{background-color:<?php echo $complete['featured_block_bg'] ?>;}
.featuredinfomain:hover .featured-thumb{background-color:<?php echo $complete['featured_block_hvr_bg'] ?>;}

.featured-cont-box h3{color:<?php echo $complete['featured_block_titlecolor'] ?>;}
.featuredinfomain:hover h3{color:<?php echo $complete['featured_block_title_hvcolor'] ?> !important;}
 

.featuredinfomain:hover .featuredinfoarea h2, .featuredinfomain:hover .featurecontent li{border-bottom-color:<?php echo $complete['featured_block_hvborder'] ?>;}

.sktmore{background-color:<?php echo $complete['featured_block_button_bg'] ?>;}
.sktmore:hover, .featuredinfomain:hover .sktmore{background-color:<?php echo $complete['featured_block_hover_button_bg'] ?>;}
...
.headingseperator h3{color:<?php echo $complete['h_seperator_color'] ?>;}
.headingseperator h3::after{border-bottom-color:<?php echo $complete['h_seperator_border_color'] ?>;}
...
.post_block_style3{background-color:<?php echo $complete['style3_bg_color'] ?>;}

.post_block_style3:hover .rcntdate, .style3thumb{background-color:<?php echo $complete['style3_border_color'] ?>;}
.dte{border-bottom-color:<?php echo $complete['style3_border_color'] ?>;}
.rcntdate{border-color:<?php echo $complete['style3_border_color'] ?>;}
...
/*Home Section 3*/
.home3_section_area .sect-title h2{color:<?php echo $complete['section3_title_color'] ?>;}
.home3_section_area .sect-title h2:after{border-bottom-color:<?php echo $complete['section3_seprator_color'] ?>;}
...
/*Home Section 4*/
.home4_section_area .sect-title h2{color:<?php echo $complete['section4_title_color'] ?>;}
.home4_section_area .sect-title h2:after{border-bottom-color:<?php echo $complete['section4_seprator_color'] ?>;}
...
/*Home Section 5*/
.home5_section_area .sect-title h2{color:<?php echo $complete['section5_title_color'] ?>;}
.home5_section_area .sect-title h2:after{border-bottom-color:<?php echo $complete['section5_seprator_color'] ?>;}
...
/*Home Section 6*/
.home6_section_area .sect-title h2{color:<?php echo $complete['section6_title_color'] ?>;}
.home6_section_area .sect-title h2:after{border-bottom-color:<?php echo $complete['section6_seprator_color'] ?>;}
...
/*Home Section 7*/
.home7_section_area .sect-title h2{color:<?php echo $complete['section7_title_color'] ?>;}
.home7_section_area .sect-title h2:after{border-bottom-color:<?php echo $complete['section7_seprator_color'] ?>;}
...
/*Home Section 8*/
.home8_section_area .sect-title h2{color:<?php echo $complete['section8_title_color'] ?>;}
.home8_section_area .sect-title h2:after{border-bottom-color:<?php echo $complete['section8_seprator_color'] ?>;}
...
/*Home Section 9*/
.home9_section_area .sect-title h2{color:<?php echo $complete['section9_title_color'] ?>;}
.home9_section_area .sect-title h2:after{border-bottom-color:<?php echo $complete['section9_seprator_color'] ?>;}
...
/*Home Section 10*/
.home10_section_area .sect-title h2{color:<?php echo $complete['section10_title_color'] ?>;}
.home10_section_area .sect-title h2:after{border-bottom-color:<?php echo $complete['section10_seprator_color'] ?>;}
...
/*Home Section 11*/
.home11_section_area .sect-title h2{color:<?php echo $complete['section11_title_color'] ?>;}
.home11_section_area .sect-title h2:after{border-bottom-color:<?php echo $complete['section11_seprator_color'] ?>;}
...
/*Home Section 12*/
.home12_section_area .sect-title h2{color:<?php echo $complete['section12_title_color'] ?>;}
.home12_section_area .sect-title h2:after{border-bottom-color:<?php echo $complete['section12_seprator_color'] ?>;}
.home12_section_area{background-color:<?php echo $complete['section12_bgcolor_id'] ?>;}
.home12_section_area_bg{background:url(<?php echo $complete['section12_bg_image'] ?>);}

/*Home Section 13*/
.home13_section_area .sect-title h2{color:<?php echo $complete['section13_title_color'] ?>;}
.home13_section_area .sect-title h2:after{border-bottom-color:<?php echo $complete['section13_seprator_color'] ?>;}
.home13_section_area{background-color:<?php echo $complete['section13_bgcolor_id'] ?>;}
.home13_section_area_bg{background:url(<?php echo $complete['section13_bg_image'] ?>);}

/*Home Section 14*/
.home14_section_area .sect-title h2{color:<?php echo $complete['section14_title_color'] ?>;}
.home14_section_area .sect-title h2:after{border-bottom-color:<?php echo $complete['section14_seprator_color'] ?>;}
.home14_section_area{background-color:<?php echo $complete['section14_bgcolor_id'] ?>;}
.home14_section_area_bg{background:url(<?php echo $complete['section14_bg_image'] ?>);}

/*Home Section 15*/
.home15_section_area .sect-title h2{color:<?php echo $complete['section15_title_color'] ?>;}
.home15_section_area .sect-title h2:after{border-bottom-color:<?php echo $complete['section15_seprator_color'] ?>;}
.home15_section_area{background-color:<?php echo $complete['section15_bgcolor_id'] ?>;}
.home15_section_area_bg{background:url(<?php echo $complete['section15_bg_image'] ?>);}


/*Home Section 16*/
.home16_section_area .sect-title h2{color:<?php echo $complete['section16_title_color'] ?>;}
.home16_section_area .sect-title h2:after{border-bottom-color:<?php echo $complete['section16_seprator_color'] ?>;}
.home16_section_area{background-color:<?php echo $complete['section16_bgcolor_id'] ?>;}
.home16_section_area_bg{background:url(<?php echo $complete['section16_bg_image'] ?>);}


/*Home Section 17*/
.home17_section_area .sect-title h2{color:<?php echo $complete['section17_title_color'] ?>;}
.home17_section_area .sect-title h2:after{border-bottom-color:<?php echo $complete['section17_seprator_color'] ?>;}
.home17_section_area{background-color:<?php echo $complete['section17_bgcolor_id'] ?>;}
.home17_section_area_bg{background:url(<?php echo $complete['section17_bg_image'] ?>);}
...
/*-----------------------------COLORS------------------------------------*/
		...
		.phntp i{border-color:<?php echo $complete['tpbt_color_id']; ?>;}	
		
		a:link, a:visited, .head-info-area a:link, .head-info-area a:visited, #sidebar .widget li a, #sidebar .widget a{color:<?php echo $complete['global_link_color_id']; ?>;}
		a:hover{color:<?php echo $complete['global_link_hvcolor_id']; ?> !important;}
		...
		.slidebtn a{ 
			color:<?php echo $complete['sldbtntext_color_id']; ?>; border-color:<?php echo $complete['sldbtn_color_id']; ?> !important;
		}	
		...
		.testimonial-box{ 
			...
			color:<?php echo $complete['testimonialbox_txt_color']; ?>;
		}	
		...
		.testimonilacontent{background-color:<?php echo $complete['testimonialbox_color_id']; ?>; border-color:<?php echo $complete['testimonialbox_border_color']; ?>;}
		...
		.bx-wrapper .bx-pager.bx-default-pager a:link, .bx-wrapper .bx-pager.bx-default-pager a:visited, .bx-wrapper .bx-next, .bx-wrapper .bx-prev{ 
			background-color:<?php echo $complete['testimonial_pager_color_id']; ?>;
		}	
		...
		.bx-wrapper .bx-pager.bx-default-pager a:hover, .bx-wrapper .bx-pager.bx-default-pager a.active, .bx-wrapper .bx-prev:hover, .bx-wrapper .bx-next:hover{ 
			background-color:<?php echo $complete['testimonial_activepager_color_id']; ?>;
		}
		...
		#topmenu .menu_hover > a:link, #topmenu .menu_hover > a:visited, #topmenu ul li.current-menu-item>a:link, #topmenu ul li.current-menu-item>a:visited, #topmenu ul li.current-menu-parent>a:link, #topmenu ul li.current_page_parent>a:visited, #topmenu ul li.current-menu-ancestor>a:link, #topmenu ul li.current-menu-ancestor>a:visited{	border-bottom-color:<?php echo $complete['mnbg_color_id']; ?>;}
