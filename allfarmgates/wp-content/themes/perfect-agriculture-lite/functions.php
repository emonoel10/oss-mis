<?php
/**
 * The MAIN FUNCTIONS FILE for Perfect Agriculture Lite
 *
...
define('SKT_THEME_DOC', 'http://sktthemesdemo.net/documentation/perfect-documentation','perfect-agriculture-lite');
define('SKT_URL','https://www.sktthemes.net','perfect-agriculture-lite');
define('SKT_PRO_THEME_URL','https://www.sktthemes.net/shop/commercial-wordpress-theme/','perfect-agriculture-lite');
define('SKT_LIVE_DEMO','http://sktperfectdemo.com/demos/agriculture/','perfect-agriculture-lite');
define('SKT_THEMES','https://www.sktthemes.net/themes/','perfect-agriculture-lite');
