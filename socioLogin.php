...
<hr>
<h3 style="color: #077054; font-family: latoregular;"><center>
...
<fieldset><legend><h1 style="font-family: Century Gothic; font-size: 50px;">Log in</h1></legend>
  ...
  <form class="modal-content animate" method="POST">
    ...
    <div class="container">
      <label style="font-family: Century Gothic;"><i class="fa fa-address-book" aria-hidden="true"></i><b>Username</b></label>
