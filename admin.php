...
<body>
  ...
  <div id="body"><br><br>
  <h2 align = "center" style="font-family: century gothic;">SOCIO-ECONOMIC PROFILING</h2>
<hr>
<h3 style="color: black;"><center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
This is the socio-economic profiling of Davao del Norte State College (DNSC). It covers the personal data of students, their social status and economic status of their students.</center></h3>
<br><br><br><br>
<fieldset><legend><h1 style="font-family: Century Gothic; font-size: 50px;">Log in</h1></legend>
  ...
  <form class="modal-content animate" action="" method="POST">
    <div class="imgcontainer">
     ...
     <h1 style="font-family: century gothic;"></h1>    </div>

    <div class="container">
      <label style="font-family: Century Gothic;"><b>Email/Username</b></label>
      <input type="text" name="adminname" required>

      <label style="font-family: Century Gothic;"><b>Password</b></label>
      <input type="password" name="adminpass" required>
      <span style = "color: red;"><?php echo $error; ?></span>
      <p style = "color: red;"><?php echo $postData; ?></p>

      <button type="submit" name = "submitAdmin">Login</button>
      <p> Not an Admin? <a href = "socioLogin.php" style="text-decoration: none;"> Login here. </a></p>
    </div>
