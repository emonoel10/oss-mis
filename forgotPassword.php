...
<html>
    ...
    <body>
        <div id="header">
            <h1>
                <a href="home.php">SOCIO-ECONOMIC PROFILING &amp; GRADUATE TRACER SURVEY </a>
            </h1>
        </div>
        <div id="body">
            ...
            <fieldset>
                ...
                <form class="modal-content animate" id="resendEmailForm" method="POST">
                    <div class="container">
                        ...
                        <button name="accountSubmit" type="submit">Submit</button>
                        <br>
                        <br>
                        <div>
